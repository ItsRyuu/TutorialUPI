            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                    <h3 class="pb-3">Rekapan Absensi</h3>
                    <a href="{{ route('absen.create') }}" class="btn btn-primary mb-3">Tambah</a>  
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <a href="{{ route('absen.edit', ['id' => $absen->id]) }}" class="btn btn-warning btn-sm">Edit</a> 
                              <form action="{{ route('absen.destroy', ['postid' => $absen->id]) }}" method="post" style="display:inline">
                                  @csrf
                                  @method('DELETE')
