            ...
            <div class="col-sm-12">
              <div class="home-tab">
                ...
                <div class="container">
                    ...
                    <form action="{{ route('absen.update', ['absen' => $absens->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                
                        <div class="form-group">
                            <label for="judul">Title:</label>
                            <input value="{{ $absens->judul }}" class="form-control" id="judul" name="judul" required>
                        </div>
                
                        <div class="form-group">
                            <label for="link">Link:</label>
                            <input value="{{ $absens->link }}" class="form-control" id="link" name="link" required>
                        </div>
